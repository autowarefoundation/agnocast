...
#
# Example:
#   ./scripts/switch_kmod.bash 2.4.0
#
...
if ! [[ "${target_version}" =~ ^[0-9]+\.[0-9]+\.[0-9]+$ ]]; then
	echo "Error: version must be in full X.Y.Z form (e.g., 2.4.0); got '${target_version}'." >&2
	echo "       Short forms like '2.4' or 'v2.4.0' are not accepted." >&2
	exit 1
fi
